...
import com.bingo.custom.library.R


class CustomImageView @JvmOverloads constructor(context: Context, attributeSet: AttributeSet? = null, defAttrStyle: Int = 0)
    ...
    private fun initAttrs(context: Context, attributeSet: AttributeSet?, defAttrStyle: Int) {
        val array = context.obtainStyledAttributes(attributeSet, R.styleable.CustomImageView, defAttrStyle, 0)
        (0..array.indexCount)
            .asSequence()
            .map { array.getIndex(it) }
            .forEach {
                when (it) {
                    R.styleable.CustomImageView_shape_type ->
                        mShapeType = when {
                    ...
                    R.styleable.CustomImageView_left_bottom_radiusY ->
                    ...
                    R.styleable.CustomImageView_right_bottom_radiusX ->
                    ...
                    R.styleable.CustomImageView_right_bottom_radiusY ->
