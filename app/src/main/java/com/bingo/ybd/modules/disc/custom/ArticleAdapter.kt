...
class ArticleAdapter(val mContext:Context,val articleList:List<ArticleModel>): RecyclerView.Adapter<ArticleAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        var data = articleList.get(position)
